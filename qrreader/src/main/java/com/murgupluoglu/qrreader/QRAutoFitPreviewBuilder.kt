 ...
 */
class QRAutoFitPreviewBuilder private constructor(config: PreviewConfig,
    ...
    private fun updateTransform(texture: TextureView?, rotation: Int?, newBufferDimens: Size,
    ...
    companion object {
        ...
        fun build(config: PreviewConfig, viewFinder: TextureView) =
            QRAutoFitPreviewBuilder(config, WeakReference(viewFinder)).useCase
    }
}